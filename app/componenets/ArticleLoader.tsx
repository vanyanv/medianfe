    ...
    <div className='mx-auto h-full max-w-7xl sm:px-6 lg:px-8'>
      <div className='space-y-16'>
        {[...Array(3)].map((_, index) => (
          <motion.article
            key={index}
            className='flex max-w-xl flex-col items-start justify-between p-5 bg-gray-300 shadow-lg rounded-lg'
            initial={{ opacity: 0.5 }}
            animate={{ opacity: 1 }}
            transition={{
              duration: 1,
          ...
          >
            ...
            <div className='relative mt-8 flex items-center gap-x-4'>
              <div className='h-10 w-10 rounded-full bg-gray-400 border-2 border-gray-400'></div>
